...
<!-- 
            ...
            <div class="container p-1 mb-2 bg-secondary text-white">
                <div class="row">
                    ...
                    <div class="col-sm d-flex justify-content-center">
                    <svg class="center" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gender-female" viewBox="0 0 16 16">
                    ...
                    <div class="card text-center" style="width: 15rem;">
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <br>
                                {{$province->man_population + $province->woman_population}}
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- get fata from Open API (apikeynya milik pak sandika galih unpas)-->

<!-- <script>
    $('#search-film').on('click', function(){
        $.ajax({
